...
test_file_name = '../Data/study/ID006_filtered_MAF_pos_ori10.csv'
...
# 여러 데이터로, 압력 안쓰고 의사들 데이터로, 힘을 키웠을때
load_model_name = 'Models/Twohands_withOri_force_2LSTM_seq17_23092021.h5'
...
if load_trained_model:
    ...
    tf.model.add(tf.keras.layers.LSTM(units=256, return_sequences=True, input_shape=(seq_length, data_dim)))
    tf.model.add(tf.keras.layers.LSTM(units=128))
